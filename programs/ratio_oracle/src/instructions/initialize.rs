...
use crate::{constants, errors::RatioOracleError, state::Config};
...
pub struct Initialize<'info> {
    #[account(mut,
        constraint = deployer.key() == program_data.upgrade_authority_address.unwrap_or_default() @ RatioOracleError::Unauthorized)
    ]
