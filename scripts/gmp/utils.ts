...
export function getAssetRouterMessagingAuthorityPDA(program: PublicKey) {
  return PublicKey.findProgramAddressSync([ASSET_ROUTER_MESSAGING_AUTHORITY_SEED], program)[0];
}
