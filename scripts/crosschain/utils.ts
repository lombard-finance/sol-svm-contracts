...
import { BRIDGE_CONFIG_SEED, BRIDGE_LOCAL_TOKEN_CONFIG_SEED, BRIDGE_REMOTE_TOKEN_CONFIG_SEED, BRIDGE_SENDER_CONFIG_SEED, TOKEN_POOL_CHAIN_CONFIG_SEED, TOKEN_POOL_SIGNER_SEED, TOKEN_POOL_STATE_SEED } from "./constants";
...
export function getBridgeRemoteTokenConfigPDA(mint: PublicKey, chainId: Buffer, program: PublicKey) {
  return PublicKey.findProgramAddressSync([BRIDGE_REMOTE_TOKEN_CONFIG_SEED, mint.toBytes(), chainId], program)[0];
}
