...
if (process.argv.indexOf("--help") > -1) {
  console.log(`Usage: PROGRAM_ID=<program_id> ANCHOR_PROVIDER_URL=<rpc_url> ANCHOR_WALLET=<wallet_path> yarn postValsetSignatures <valset_payload> <signatures> <indices>

    Adds signatures to a <valset_payload>.
...
(async () => {
  try {
    ...
    console.error("Error posting valset signatures:", err);
  }
})();
