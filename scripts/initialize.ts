...
(async () => {
  try {
    ...
    const treasuryHolder = new PublicKey("GVWzHqHokErK4KPjvio6XqoVkvu5KGfwcLnQnmmbzRyp");
    const treasury = await spl.createAssociatedTokenAccount(provider.connection, payer, mint, treasuryHolder);
